...
namespace identityserver4_ef_template.Pages.Admin.Clients;
...
public class ClientRepository
{
    ...
    public async Task<ClientModel?> GetByIdAsync(string id)
    {
        ...
        return new ClientModel
        {
            ...
            RequiredPkce = client.RequirePkce,
        };
    }
...
#pragma warning restore CA1849 // Call async methods when in an async method
    ...
    public async Task UpdateAsync(ClientModel model)
    {
        ...
        if (flow == Flow.CodeFlowWithPkce)
        {
            ...
            if(client.RequirePkce != model.RequiredPkce)
            {
                client.RequirePkce = model.RequiredPkce ?? true;
            }
