...
namespace identityserver4_ef_template.Pages.Create;
...
public class Index : PageModel
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        {
            ModelState.AddModelError("Input.Username", "username's already taken");
        }

        if (ModelState.IsValid)
        {
            var identityUser = new IdentityUser { UserName = Input.Username, Email = Input.Email};
