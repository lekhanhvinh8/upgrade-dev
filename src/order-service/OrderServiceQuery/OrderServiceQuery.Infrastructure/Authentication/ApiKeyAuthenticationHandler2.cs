...
{
    public class ApiKeyAuthenticationHandler2 : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        public ApiKeyAuthenticationHandler2(IOptionsMonitor<AuthenticationSchemeOptions> options,
        ...
        {
            Console.WriteLine("AuthenSchema2");
            if (!Request.Headers.TryGetValue("X-Api-Key2", out var apiKey))
            {
            ...
            var identity = new ClaimsIdentity(claims, nameof(ApiKeyAuthenticationHandler2));
